...
export default function OnboardingPage() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const json = await res.json() as { vendorId?: string; error?: string };
      ...
      logger.info('OnboardingPage: vendor created', { vendorId: json.vendorId });
    ...
    <main className="min-h-screen flex items-center justify-center bg-[#FAFAF8] px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-10">
          ...
          <p className="mt-2 text-sm text-gray-400 tracking-wide">Vendor Portal</p>
        </div>

        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          <div className="mb-6">
            <h2 className="text-lg font-semibold text-gray-800">Set up your business</h2>
